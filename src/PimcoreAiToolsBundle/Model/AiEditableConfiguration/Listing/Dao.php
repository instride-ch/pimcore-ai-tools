...
namespace Instride\Bundle\PimcoreAiToolsBundle\Model\AiEditableConfiguration\Listing;

use Doctrine\DBAL\Exception;
use Instride\Bundle\PimcoreAiToolsBundle\Model\AiEditableConfiguration;
use Instride\Bundle\PimcoreAiToolsBundle\Model\AiEditableConfiguration\Listing;
use Pimcore\Model;
...
{
    protected string $tableName = 'pimcore_ai_tools_editable_configuration';
