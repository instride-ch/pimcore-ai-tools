...
/**
 * @property AiTranslationObjectConfiguration $model
 */
final class Dao extends AbstractDao
{
    ...
    public function getById(?int $id = null): void
    {
        ...
        if (!$data) {
            throw new NotFoundException(\sprintf('Unable to load translation object configuration with ID `%s`', $this->model->getId()));
        }
